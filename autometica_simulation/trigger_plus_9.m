function [tmarr, marker] = trigger_plus_9(tm)
    nontm = find(~tm);
                    ...
                    for a5 = a4+1:SizeOfnontm(2)
                        for a6 = a5+1:SizeOfnontm(2)
                            for a7 = a6+1:SizeOfnontm(2)
                                ...
                                tm(nontm(a7)) = 1;
                                result = [result; tm];
                                if a1 ==1 && a2 == a1+1 && a3 == a2+1 && a4 == a3+1 && a5 == a4+1 && a6 == a5+1 && a7 == a6+1
                                    temp = size(result);
                                    marker = [marker, temp(1)];
                                end
                            end
                        ...
                        for a6 = a5+1:SizeOfnontm(2)
                            for a7 = a6+1:SizeOfnontm(2)
                                for a8 = a7+1:SizeOfnontm(2)
                                    ...
                                    tm(nontm(a8)) = 1;
                                    result = [result; tm];
                                    if a1 ==1 && a2 == a1+1 && a3 == a2+1 && a4 == a3+1 && a5 == a4+1 && a6 == a5+1 && a7 == a6+1 && a8 == a7+1
                                        temp = size(result);
                                        marker = [marker, temp(1)];
                                    end
                                end
                            ...
                            for a7 = a6+1:SizeOfnontm(2)
                                for a8 = a7+1:SizeOfnontm(2)
                                    for a9 = a8+1:SizeOfnontm(2)
                                        ...
                                        tm(nontm(a9)) = 1;
                                        result = [result; tm];
                                        if a1 ==1 && a2 == a1+1 && a3 == a2+1 && a4 == a3+1 && a5 == a4+1 && a6 == a5+1 && a7 == a6+1 && a8 == a7+1 && a9 == a8+1
                                            temp = size(result);
                                            marker = [marker, temp(1)];
                                        end
                                    end
